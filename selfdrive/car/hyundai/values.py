...
class CarControllerParams:
  ...
  def __init__(self, CP, vEgoRaw=100., frogpilot_toggles=None):
    ...
    if CP.carFingerprint in CANFD_CAR and frogpilot_toggles and frogpilot_toggles.taco_tune_hacks:
      self.STEER_MAX = 720 if vEgoRaw < 18. else 400
      self.STEER_DRIVER_ALLOWANCE = 250
      self.STEER_DRIVER_MULTIPLIER = 2
      self.STEER_THRESHOLD = 250
      self.STEER_DELTA_UP = 5 if vEgoRaw < 18. else 2
      self.STEER_DELTA_DOWN = 10 if vEgoRaw < 18. else 3
    ...
    # Default for most HKG
      ...
      self.STEER_MAX = 400 #384 previous
